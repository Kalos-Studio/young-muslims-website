 ...
 *
 * Real links, not placeholders, for the same reason the wordmark is real type —
 * the footer is permanent, so it should not import anything disposable. What is
  ...
  return (
    <footer className="mt-32 border-t border-border">
      <div className="mx-auto flex max-w-[90rem] items-start justify-between gap-16 px-10 py-16">
        <div>
          <p className="text-xl leading-[0.95] font-bold tracking-tighter uppercase">
            <span className="block">Young</span>
            <span className="block">Muslims</span>
          </p>
